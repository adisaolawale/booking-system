// Was a static array with 20 hardcoded testimonials — now the data lives in
// the database (Testimonial model). This file just re-exports the Prisma
// type so components don't need to know/care where the type comes from.
export type { Testimonial } from "@/generated/prisma";
